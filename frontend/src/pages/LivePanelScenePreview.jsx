...
const SCENE_OPTIONS = [
    { id: 'atlas-live-default', label: 'Default Orb' },
    { id: 'atlas-live-brain', label: 'Brain Core' },
    { id: 'atlas-live-stitch', label: 'Stitch Waves' },
    { id: 'atlas-live-hex', label: 'HexaCube Core' },
    { id: 'atlas-live-aether', label: 'Aether Minimal' }
];

function getPreviewParams() {
    if (typeof window === 'undefined') {
        return {
            sceneId: 'atlas-live-default',
            status: 'idle',
            micIntensity: 0.45,
            ttsIntensity: 0.35,
            recording: true,
    ...
    return {
        sceneId: SCENE_OPTIONS.some((option) => option.id === sceneId) ? sceneId : 'atlas-live-default',
...
export default function LivePanelScenePreview() {
    return (
        <ThemeProvider>
            <PreviewSurface />
        </ThemeProvider>
