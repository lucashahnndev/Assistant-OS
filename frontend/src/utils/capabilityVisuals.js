...
const FALLBACK_VISUAL = { key: 'default', label: 'Capability', logoUrl: '', Icon: Puzzle, color: '#a78bfa' };
...
export const getCapabilityVisual = ({ capabilityId = '', capabilityName = '', actionId = '', iconKey = '', iconUrl = '' } = {}) => {
    ...
    const combined = normalize([capabilityId, capabilityName, actionId].filter(Boolean).join(' '));
