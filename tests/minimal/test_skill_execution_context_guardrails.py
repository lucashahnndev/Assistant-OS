...
from src.core.orchestrator import AgentOrchestrator, _SkillSessionView
...
def test_skill_session_view_blocks_direct_messaging():
    view = _SkillSessionView(_FakeSession())
...
def test_skill_callbacks_view_exposes_only_send_status():
    captured = []
    ...
    filtered = AgentOrchestrator._build_skill_callbacks_view(callbacks)
