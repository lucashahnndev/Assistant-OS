...
2. locator tenta primeiro `vision.locate_screen` (contrato da skill de visao)
...
Para diagnosticar incoerencia de coordenadas, a skill pode renderizar uma imagem de debug:
