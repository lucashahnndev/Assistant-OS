...
def _refresh_google_token_if_needed(
    *,
    ...
    client_id = _resolve_env_ref(cfg.get("client_id") or cfg.get("client_id_ref"))
    client_secret = _resolve_env_ref(cfg.get("client_secret") or cfg.get("client_secret_ref"))
...
def resolve_google_request_auth(
    *,
    ...
    """
    source = str(os.getenv(AUTH_SOURCE_ENV, "auto") or "auto").strip().lower()
