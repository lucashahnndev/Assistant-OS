...
from src.capabilities.browser_control.runtime import BrowserRuntime
...
# In a real scenario, this method would be added to src/capabilitys/browser_control/runtime.py.
