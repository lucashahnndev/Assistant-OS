...
class VisionLocator:
    ...
    def _locate_via_vision_capability(
        self,
        label: str,
        ...
        if not capability_registry or not hasattr(capability_registry, "get_capability_for_action"):
            return None
        if not capability_registry.get_capability_for_action("vision.locate_screen"):
            return None
    ...
    def locate(
        ...
        routed = self._locate_via_vision_capability(label, session_id, hint, context=context)
