...
logger = logging.getLogger("WikipediaSearchCapability")


class WikipediaSearchCapability(CapabilityBase):
    USER_AGENT = "Assistant-OS/1.0 (knowledge-capability; +https://github.com/)"
