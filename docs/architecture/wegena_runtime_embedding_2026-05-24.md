# Wegena Runtime Embedding

The Atlas frontend now serves the Wegena runtime from files stored inside this repository instead of depending on the external workspace symlink.
...
- Removes hidden coupling through `frontend/public/wegena` symlink
